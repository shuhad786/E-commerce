    ...
    <div className="overscroll-y-none">
      <div className="flex w-full justify-between">
        <div className="flex w-2/5 justify-evenly">
          ...
          <button onClick={handleByWomenClothing} className="px-4 py-2 mr-2 bg-slate-200 font-semibold rounded-full hover:bg-emerald-400 hover:text-white">Women's Clothing <i className="fa-solid fa-angle-down ml-1"></i></button>
        ...
        <button onClick={handleByAll} className="px-4 py-2 mr-2 bg-slate-200 font-semibold rounded-full hover:bg-emerald-400 hover:text-white">Display all <i className="fa-solid fa-angles-down"></i></button>
      </div>
      {items?.map((item) => (
